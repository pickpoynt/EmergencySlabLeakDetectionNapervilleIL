          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <span className="text-sm text-muted-foreground block">24/7 Emergency Line</span>
                  <span className="font-heading font-bold text-xl text-foreground">(877) 792-1410</span>
                </div>
              </a>

              <a
                href="mailto:info@napervilleslableak.com"
                className="flex items-center gap-4 p-4 rounded-xl bg-card border border-border hover:border-copper/30 hover:shadow-md transition-all duration-300 group"
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-hero flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <div>
                  ...
                  <span className="font-heading font-bold text-foreground">info@napervilleslableak.com</span>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-card border border-border">
                ...
                <div>
                  ...
                  <span className="font-heading font-semibold text-foreground">Naperville & DuPage County</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-card border border-border">
                ...
                <div>
                  ...
                  <span className="font-heading font-semibold text-foreground">24 Hours / 7 Days a Week</span>
                </div>
              </div>
            </div>
          </div>
